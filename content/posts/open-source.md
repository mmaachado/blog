...
Foi então que, navegando pela rede atrás de algum tutorial — se não me engano, sobre autenticação via AzureAD com FastAPI —, encontrei o projeto [FastAPI do Zero](https://fastapidozero.dunossauro.com/estavel/), ainda em suas fases iniciais, apenas em texto, com os módulos finais em desenvolvimento.
